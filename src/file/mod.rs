use deku::{
    bitvec::{BitSlice, BitVec, Msb0, BitView},
    prelude::*,
};
...
use crate::{network::{Address, AddressType}, utils::pad_rest};
...
pub enum FileId {
    ...
    #[deku(id_pat = "0x07 | 0x14..=0x16")] Rfu,
    #[deku(id_pat = "0x18..=0x1F")] D7AalpRfu,
    #[deku(id="0x20")] AccessProfile00,
    #[deku(id="0x21")] AccessProfile01,
    #[deku(id="0x22")] AccessProfile02,
    #[deku(id="0x23")] AccessProfile03,
    #[deku(id="0x24")] AccessProfile04,
    #[deku(id="0x25")] AccessProfile05,
    #[deku(id="0x26")] AccessProfile06,
    #[deku(id="0x27")] AccessProfile07,
    #[deku(id="0x28")] AccessProfile08,
    #[deku(id="0x29")] AccessProfile09,
    #[deku(id="0x2A")] AccessProfile10,
    #[deku(id="0x2B")] AccessProfile11,
    #[deku(id="0x2C")] AccessProfile12,
    #[deku(id="0x2D")] AccessProfile13,
    #[deku(id="0x2E")] AccessProfile14,
    #[deku(id_pat="_")] Other,
}
...
#[derive(DekuRead, DekuWrite, Debug, Clone, PartialEq)]
#[deku(ctx = "file_id: FileId, length: u32", id = "file_id", ctx_default="FileId::Other, 0")]
pub enum File {
